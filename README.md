...
```
directory % cd .../whirlpool
directory/whirlpool % python3 -m venv .
directory/whirlpool % source ./bin/activate
directory/whirlpool % pip install pandas 
directory/whirlpool % pip install jinja2 
directory/whirlpool % pip install jupyter 
directory/whirlpool % python3 -m pip install --upgrade pip
directory/whirlpool % python3 -m pip install --upgrade pybatfish
```
